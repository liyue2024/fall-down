(function () {
  ...
  const packs = {
    "en": makePack(
      ...
      "{appName} is an offline-friendly arcade game for iPhone and iPad.",
      "Privacy Policy",
      "{appName} is an offline-friendly arcade game. You can start playing without logging in, and your settings and scores stay on your device for a clean, focused experience.",
      [
    ...
    "fr": makePack(
      ...
      "{appName} est un jeu d'arcade pensé pour iPhone et iPad.",
      "Politique de confidentialité",
      "{appName} est un jeu d'arcade pensé pour jouer aussi hors ligne. Vous pouvez commencer sans vous connecter, et vos réglages ainsi que vos scores restent sur votre appareil pour une expérience claire et concentrée.",
      [
    ...
    "es": makePack(
      ...
      "{appName} es un juego arcade para iPhone y iPad.",
      "Política de privacidad",
      "{appName} es un juego arcade apto para jugar sin conexión. Puedes empezar sin iniciar sesión, y tus ajustes y puntuaciones permanecen en tu dispositivo para una experiencia limpia y centrada.",
      [
    ...
    "de": makePack(
      ...
      "{appName} ist ein Arcade-Spiel für iPhone und iPad.",
      "Datenschutzrichtlinie",
      "{appName} ist ein offlinefreundliches Arcade-Spiel. Du kannst ohne Anmeldung spielen; Einstellungen und Ergebnisse bleiben für ein klares, konzentriertes Erlebnis auf deinem Gerät.",
      [
    ...
    "pt-BR": makePack(
      ...
      "{appName} é um jogo arcade para iPhone e iPad.",
      "Política de Privacidade",
      "{appName} é um jogo arcade feito para também funcionar offline. Você pode começar sem fazer login, e suas configurações e pontuações ficam no seu dispositivo para uma experiência limpa e focada.",
      [
    ...
    "pt-PT": makePack(
      ...
      "{appName} é um jogo arcade para iPhone e iPad.",
      "Política de Privacidade",
      "{appName} é um jogo arcade concebido para também funcionar offline. Pode começar sem iniciar sessão, e as suas definições e pontuações ficam no dispositivo para uma experiência limpa e focada.",
      [
    ...
    "it": makePack(
      ...
      "{appName} è un gioco arcade per iPhone e iPad.",
      "Informativa sulla privacy",
      "{appName} è un gioco arcade pensato per funzionare anche offline. Puoi iniziare senza accedere, mentre impostazioni e punteggi restano sul dispositivo per un'esperienza pulita e concentrata.",
      [
    ...
    "nl": makePack(
      ...
      "{appName} is een arcadegame voor iPhone en iPad.",
      "Privacybeleid",
    ...
    "sv": makePack(
      ...
      "{appName} är ett arkadspel för iPhone och iPad.",
      "Integritetspolicy",
    ...
    "da": makePack(
      ...
      "{appName} er et arkadespil til iPhone og iPad.",
      "Privatlivspolitik",
    ...
    "nb": makePack(
      ...
      "{appName} er et arkadespill for iPhone og iPad.",
      "Personvernerklæring",
    ...
    "fi": makePack(
      ...
      "{appName} on arcade-peli iPhonelle ja iPadille.",
      "Tietosuojakäytäntö",
    ...
    "pl": makePack(
      ...
      "{appName} to gra arcade na iPhone'a i iPada.",
    ...
    "cs": makePack(
      ...
      "{appName} je arkádová hra pro iPhone a iPad.",
    ...
    "sk": makePack(
      ...
      "{appName} je arkádová hra pre iPhone a iPad.",
    ...
    "hr": makePack(
      ...
      "{appName} je arkadna igra za iPhone i iPad.",
      "Pravila privatnosti",
    ...
    "ro": makePack(
      ...
      "{appName} este un joc arcade pentru iPhone și iPad.",
    ...
    "hu": makePack(
      ...
      "{appName} arcade játék iPhone-ra és iPadre.",
    ...
    "tr": makePack(
      ...
      "{appName}, iPhone ve iPad için bir arcade oyunudur.",
      "Gizlilik Politikası",
    ...
    "ru": makePack(
      ...
      "{appName} — аркадная игра для iPhone и iPad.",
    ...
    "uk": makePack(
      ...
      "{appName} — аркадна гра для iPhone та iPad.",
    ...
    "el": makePack(
      ...
      "Το {appName} είναι ένα arcade παιχνίδι για iPhone και iPad.",
      "Πολιτική απορρήτου",
    ...
    "ca": makePack(
      ...
      "{appName} és un joc arcade per a iPhone i iPad.",
    ...
    "id": makePack(
      ...
      "{appName} adalah game arcade untuk iPhone dan iPad.",
      "Kebijakan Privasi",
    ...
    "ms": makePack(
      ...
      "{appName} ialah permainan arked untuk iPhone dan iPad.",
      "Dasar Privasi",
    ...
    "vi": makePack(
      ...
      "{appName} là trò chơi arcade dành cho iPhone và iPad.",
    ...
    "ja": makePack(
      "言語", "プライバシーポリシー", "サポート",
      "{appName}は iPhone と iPad 向けのアーケードゲームです。",
      "プライバシーポリシー",
    ...
    "ko": makePack(
      "언어", "개인정보 처리방침", "지원",
      "{appName}는 iPhone 및 iPad용 아케이드 게임입니다.",
      "개인정보 처리방침",
    ...
    "th": makePack(
      ...
      "{appName} เป็นเกมอาร์เคดสำหรับ iPhone และ iPad",
    ...
    "ar": makePack(
      ...
      "{appName} لعبة أركيد على iPhone و iPad.",
      "سياسة الخصوصية",
    ...
    "he": makePack(
      ...
      "{appName} הוא משחק ארקייד עבור iPhone ו-iPad.",
      "מדיניות פרטיות",
    ...
    "ur": makePack(
      ...
      "{appName} iPhone اور iPad کے لیے ایک آرکیڈ گیم ہے۔",
      "رازداری کی پالیسی",
    ...
    "hi": makePack(
      ...
      "{appName} iPhone और iPad के लिए एक आर्केड गेम है।",
      "गोपनीयता नीति",
    ...
    "mr": makePack(
      ...
      "{appName} हा iPhone आणि iPad साठी आर्केड गेम आहे.",
      "गोपनीयता धोरण",
    ...
    "bn": makePack(
      ...
      "{appName} iPhone ও iPad-এর জন্য একটি আর্কেড গেম।",
      "গোপনীয়তা নীতি",
    ...
    "ta": makePack(
      ...
      "{appName} iPhone மற்றும் iPad க்கான ஆர்கேட் விளையாட்டு.",
      "தனியுரிமைக் கொள்கை",
    ...
    "te": makePack(
      ...
      "{appName} iPhone మరియు iPad కోసం ఆర్కేడ్ గేమ్.",
      "గోప్యతా విధానం",
