...
const copy = {
  en: {
    ...
    navSupport: "Support",
    footer: "Fall Down is a paid single-player arcade game for iPhone and iPad.",
    privacy: {
      title: "Privacy Policy",
      intro: "Fall Down is a paid, offline-friendly single-player arcade game. You can start playing without logging in, and the game keeps settings and scores on your device for a clean, focused experience.",
      sections: [
...
const templateSources = {
  fr: {
    ...
    footer: "{appName} est un jeu d'arcade solo payant pour iPhone et iPad.",
    privacyTitle: "Politique de confidentialité",
    privacyIntro: "{appName} est un jeu d'arcade solo payant, utilisable hors ligne. Vous pouvez jouer sans vous connecter, avec des réglages et scores conservés sur votre appareil pour une expérience claire et concentrée.",
  ...
  es: {
    ...
    navSupport: "Soporte",
    footer: "{appName} es un juego arcade para un jugador de pago para iPhone y iPad.",
    privacyTitle: "Política de privacidad",
    privacyIntro: "{appName} es un juego arcade para un jugador, de pago y apto para jugar sin conexión. Puedes empezar sin iniciar sesión, con ajustes y puntuaciones guardados en tu dispositivo para una experiencia limpia y centrada.",
  ...
  de: {
    ...
    navSupport: "Support",
    footer: "{appName} ist ein kostenpflichtiges Einzelspieler-Arcade-Spiel für iPhone und iPad.",
    privacyTitle: "Datenschutzrichtlinie",
    privacyIntro: "{appName} ist ein kostenpflichtiges, offlinefreundliches Einzelspieler-Arcade-Spiel. Du kannst ohne Anmeldung spielen; Einstellungen und Ergebnisse bleiben für ein klares, konzentriertes Erlebnis auf deinem Gerät.",
...
function buildGenericTemplate(baseCode, appName) {
  ...
  return {
    ...
    navPrivacy: labels[1],
    navSupport: labels[2],
    footer: `${appName} is a paid single-player arcade game for iPhone and iPad.`,
    privacy: {
      title: labels[1],
      intro: `${appName} is a paid, offline-friendly single-player arcade game. You can start playing without logging in, with settings and scores kept on your device for a clean, focused experience.`,
      sections: [
...
function extraSupportSections(locale) {
  if (locale.base === "zh-Hans") {
    return [
      ...
      ["一次购买，干净体验", "《下落》是付费下载游戏。下载后即可开始，游戏过程中不会出现广告打断、订阅入口或虚拟货币商城。"],
  ...
  if (locale.base === "zh-Hant") {
    return [
      ...
      ["一次購買，乾淨體驗", "《下落》是付費下載遊戲。下載後即可開始，遊戲過程中不會出現廣告打斷、訂閱入口或虛擬貨幣商城。"],
  ...
  return [
    ...
    ["One Purchase, Clean Experience", "Fall Down is a paid download. Once downloaded, you can play without ad interruptions, subscription entry points, or virtual currency shops."],
...
function renderPage() {
  ...
  document.getElementById("brandSubtitle").textContent = pageCopy.footer;
  ...
  document.getElementById("footer").textContent = pageCopy.footer;
