...
The current wording matches the V1.0 requirement: no ads, no in-app purchases, no account system, no analytics SDK, no developer-operated server, local settings and scores, and optional Apple Game Center score submission.
